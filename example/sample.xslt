            ...
            <body
                        ...
                        <tbody>
                            <tr valign="top">
                                ...
                                <td width="20%" align="center" valign="middle">
                                    ...
                                    <img style="width:91px;" align="middle" alt="E-Fatura Logo"
                                         src="data:image/jpeg;base64,İMZA BU ALANA EKLENECEK"/>
                                    <td align="right" width="40%" valign="middle">
                                        <img  src="data:image/jpeg;base64,LOGO BU ALANA EKLENECEK" />
                                        &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
                                    </td>
                                </td>
                ...
                <table id="budgetContainerTable" width="800px">
                    ...
                    <xsl:if
                        ...
                        <tr align="right">
                            ...
                            <td id="lineTableBudgetTd" style="width:81px; " align="right">
                                <xsl:variable name="var1" select="//n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate" />

                                <xsl:value-of
                                        select="format-number(//n1:Invoice/cac:LegalMonetaryTotal/cbc:LineExtensionAmount * $var1, '###.##0,00', 'european')"/>
                                <xsl:text> TL</xsl:text>
                            </td>
                        </tr>
                        <tr id="budgetContainerTr" align="right">
                            ...
                            <td id="lineTableBudgetTd" style="width:82px; " align="right">
                                <xsl:variable name="var2" select="//n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate" />
                                <xsl:value-of
                                        select="format-number(//n1:Invoice/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount * $var2, '###.##0,00', 'european')"/>
                                <xsl:text> TL</xsl:text>
                            </td>
                        </tr>
                        <tr align="right">
                            ...
                            <td id="lineTableBudgetTd" style="width:82px; " align="right">
                                <xsl:variable name="var3" select="//n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate" />
                                <xsl:value-of
                                        select="format-number(//n1:Invoice/cac:LegalMonetaryTotal/cbc:PayableAmount * $var3, '###.##0,00', 'european')"/>
                                <xsl:text> TL</xsl:text>
                            </td>
                        </tr>
                    </xsl:if>
                ...
                <xsl:if	test="//n1:Invoice/cac:BillingReference/cac:AdditionalDocumentReference/cbc:DocumentTypeCode='OKCBF'">
                    <table border="1" id="lineTable" width="800">
                        <thead>
                            <tr id="lineTableTr">
                                <td id="lineTableTd" align="center" colspan="6">
                                    <span style="font-weight:bold; ">
                                        <xsl:text>ÖKC Bilgileri</xsl:text>
                                    </span>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr id="lineTableTr" style="font-weight:bold;">
                                ...
                                <td id="lineTableTd" style="width:35%" align="center">
                ...
                <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference">
                    <xsl:if test="./cbc:DocumentTypeCode = 'EUPRWEBURI'">
                        <table  style="margin-top:10px;margin-bottom:10px;width:800px;text-align:left; color:black;">
                            <tr>
                                <td id="notesTableTd" >
